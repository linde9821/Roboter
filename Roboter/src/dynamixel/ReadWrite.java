...
public class ReadWrite
{
  public static void main(String[] args)
  {
    ...
    short DXL_MINIMUM_POSITION_VALUE    = 50;                 // Dynamixel will rotate between this value
    short DXL_MAXIMUM_POSITION_VALUE    = 950;                // and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
