...
import dynamixel.HelloWorld.CLibrary;
...
interface LibFunction extends Library {
    ...
    public void syncReadTx(int port_num, int protocol_version, short start_address, short data_length,
	    short param_length);
    // syncReadRx -> GroupSyncRead
    // syncReadTxRx -> GroupSyncRead

    public void syncWriteTxOnly(int port_num, int protocol_version, short start_address, short data_length,
	    short param_length);
    ...
    public Boolean groupBulkWriteAddParam(int group_num, byte id, short start_address, short data_length, int data,
	    short input_length);

    public void groupBulkWriteRemoveParam(int group_num, byte id);

    public Boolean groupBulkWriteChangeParam(int group_num, byte id, short start_address, short data_length, int data,
	    short input_length, short data_pos);
...
public class Dynamixel {
    ...
    public Boolean groupBulkWriteChangeParam(int group_num, byte id, short start_address, short data_length, int data,
	    short input_length, short data_pos) {
	return libFunction.groupBulkWriteChangeParam(group_num, id, start_address, data_length, data, input_length,
		data_pos);
    }
