...
public class ProtocolCombined {
	...
	short DXL1_MINIMUM_POSITION_VALUE = 0; // Dynamixel will rotate between this value
	short DXL1_MAXIMUM_POSITION_VALUE = 1023; // and this value (note that the Dynamixel would not move when the
						  // position value is out of movable range. Check e-manual about the
	...
	short[] dxl1_goal_position = new short[] { DXL1_MINIMUM_POSITION_VALUE, DXL1_MAXIMUM_POSITION_VALUE }; // Goal
													       // position
													       // of
													       // Dynamixel
													       // MX
	int[] dxl2_goal_position = new int[] { DXL2_MINIMUM_POSITION_VALUE, DXL2_MAXIMUM_POSITION_VALUE }; // Goal
													   // position
													   // of
													   // Dynamixel
													   // PRO
	...
	while (true) {
	    ...
	    dynamixel.write2ByteTxRx(port_num, PROTOCOL_VERSION1, DXL1_ID, ADDR_MX_GOAL_POSITION,
	    ...
	    dynamixel.write4ByteTxRx(port_num, PROTOCOL_VERSION2, DXL2_ID, ADDR_PRO_GOAL_POSITION,
		...
		dxl1_present_position = dynamixel.read2ByteTxRx(port_num, PROTOCOL_VERSION1, DXL1_ID,
		...
		dxl2_present_position = dynamixel.read4ByteTxRx(port_num, PROTOCOL_VERSION2, DXL2_ID,
		...
		System.out.printf("[ID: %d] GoalPos: %d  PresPos: %d [ID: %d] GoalPos: %d  PresPos: %d\n", DXL1_ID,
			dxl1_goal_position[index], dxl1_present_position, DXL2_ID, dxl2_goal_position[index],
